      ...
      <div>
        ...
        <li>
          ...
          <em>
            ...
            and initializes state/ bind events.
          </em>
        </li>
        <li>
          super()
          <em>
            Not mandatory, constructor and super called first to access the
            React component library/ passes imported props.
          </em>
        </li>
        ...
        <li>
          ...
          <em>
            ...
            Initialize DOM nodes/ make network (HTTP requests) here.
          </em>
        </li>
        <div>
          <p></p>
        ...
        <div>
          ...
          <li>
            ...
            <em>
              ...
              renders nextProps() or nextState() when updated, here is where you
              can set the prevent default render methods and used for
              performance optimisation, rarely used
            </em>
          </li>
          <li>
